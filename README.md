...
```bash
npm install @stdlib/stats-strided-dmax-sorted
```
...
```javascript
var dmaxSorted = require( '@stdlib/stats-strided-dmax-sorted' );
```
...
#### stdlib_strided_dmax_sorted( N, \*X, strideX )
...
double v = stdlib_strided_dmax_sorted( 3, x, 1 );
// returns 3.0
```
...
```c
double stdlib_strided_dmax_sorted( const CBLAS_INT N, const double *X, const CBLAS_INT strideX );
```

#### stdlib_strided_dmax_sorted_ndarray( N, \*X, strideX, offsetX )
...
double v = stdlib_strided_dmax_sorted_ndarray( 3, x, 1, 0 );
// returns 3.0
```
...
```c
double stdlib_strided_dmax_sorted_ndarray( const CBLAS_INT N, const double *X, const CBLAS_INT strideX, const CBLAS_INT offsetX );
```
...
int main( void ) {
    ...
    double v = stdlib_strided_dmax_sorted( N, x, strideX );
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/stats-strided-dmax-sorted.svg
[npm-url]: https://npmjs.org/package/@stdlib/stats-strided-dmax-sorted

[test-image]: https://github.com/stdlib-js/stats-strided-dmax-sorted/actions/workflows/test.yml/badge.svg?branch=main
[test-url]: https://github.com/stdlib-js/stats-strided-dmax-sorted/actions/workflows/test.yml?query=branch:main

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/stats-strided-dmax-sorted/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/stats-strided-dmax-sorted?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/stats-strided-dmax-sorted.svg
[dependencies-url]: https://david-dm.org/stdlib-js/stats-strided-dmax-sorted/main
...
[deno-url]: https://github.com/stdlib-js/stats-strided-dmax-sorted/tree/deno
[deno-readme]: https://github.com/stdlib-js/stats-strided-dmax-sorted/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/stats-strided-dmax-sorted/tree/umd
[umd-readme]: https://github.com/stdlib-js/stats-strided-dmax-sorted/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/stats-strided-dmax-sorted/tree/esm
[esm-readme]: https://github.com/stdlib-js/stats-strided-dmax-sorted/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/stats-strided-dmax-sorted/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/stats-strided-dmax-sorted/main/LICENSE
